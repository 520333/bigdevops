...
type MonitorAlertManagerSendGroup struct {
	...
	// 发送逻辑
	StaticReceiveUsers  []*SystemUser `json:"staticReceiveUsers" gorm:"many2many:monitor_alert_static_receive_users;comment:静态配置的接收人列表"`
	...
	FirstUpgradeUsers []*SystemUser `json:"firstUpgradeUsers" gorm:"many2many:monitor_alert_first_upgrade_users;comment:第一升级人列表"`

	UpgradeMinutes     int           `json:"upgradeMinutes" gorm:"comment:告警多久未恢复就升级"`
	SecondUpgradeUsers []*SystemUser `json:"secondUpgradeUsers" gorm:"many2many:monitor_alert_second_upgrade_users;comment:第二升级人列表"`
...
func (obj *MonitorAlertManagerSendGroup) TransactionUpdate(firstUpgradeUsers []*SystemUser) error {
