...
func mockSystemData(sc *config.ServerConfig) *User {
	...
	apis := []*Api{
		...
		{Path: "/api/monitor/deleteMonitorScrapePool", Method: "DELETE", Title: "删除Prom集群", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/deleteMonitorScrapeJob", Method: "DELETE", Title: "删除采集任务", Type: "1", Pid: 85},
		{Path: "/api/monitor/setScrapeJobStatus", Method: "POST", Title: "设置采集任务状态", Type: "1", Pid: 85},
		// 告警规则
		{Path: "List/api/monitor/getMonitorAlertRule", Method: "GET", Title: "获取告警规则列表", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/deleteMonitorAlertRule", Method: "DELETE", Title: "删除告警规则", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/deleteMonitorRecordRule", Method: "DELETE", Title: "删除聚合规则", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/alertEventSilence", Method: "POST", Title: "静默告警事件", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertEventUnSilence", Method: "POST", Title: "解除静默", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/alertEventReLing", Method: "POST", Title: "认领告警事件", Type: "1", Pid: 85},
