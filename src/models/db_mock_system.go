...
func mockSystemData(sc *config.ServerConfig) *User {
	...
	apis := []*Api{
		...
		{Path: "/api/system/deleteMenu", Method: "DELETE", Title: "删除菜单", Type: "1", Pid: 1},
		// 角色路由
		...
		{Path: "/api/system/deleteRole", Method: "DELETE", Title: "删除角色", Type: "1", Pid: 1},
		// 账号路由
		...
		{Path: "/api/system/deleteAccount", Method: "DELETE", Title: "删除账号", Type: "1", Pid: 1},
		...
		{Path: "/api/system/deleteApi", Method: "DELETE", Title: "删除API", Type: "1", Pid: 1},
		...
		{Path: "/api/stree/deleteStreeNode", Method: "DELETE", Title: "删除服务树节点", Type: "1", Pid: 27},
		{Path: "/api/stree/getChildrenStreeNodes", Method: "GET", Title: "获取服务树子节点", Type: "1", Pid: 27},
		...
		{Path: "/api/stree/getStreeNodeEcsList", Method: "GET", Title: "获取节点ECS列表", Type: "1", Pid: 27},
		...
		{Path: "/api/workorder/deleteProcess", Method: "DELETE", Title: "删除流程", Type: "1", Pid: 48},
		// 表单设计
		...
		{Path: "/api/workorder/deleteFormDesign", Method: "DELETE", Title: "删除表单设计", Type: "1", Pid: 48},
		// 工单模板
		{Path: "/api/workorder/getWorkOrderTemplateList", Method: "GET", Title: "获取工单模板列表", Type: "1", Pid: 48},
		{Path: "/api/workorder/getWorkOrderTemplateDetail", Method: "GET", Title: "获取工单模板详情", Type: "1", Pid: 48},
		...
		{Path: "/api/workorder/deleteWorkOrderTemplate", Method: "DELETE", Title: "删除工单模板", Type: "1", Pid: 48},
		// 工单实例
		{Path: "/api/workorder/getWorkOrderInstanceList", Method: "GET", Title: "获取工单实例列表", Type: "1", Pid: 48},
		{Path: "/api/workorder/getWorkOrderInstanceDetail", Method: "GET", Title: "获取工单实例详情", Type: "1", Pid: 48},
		...
		{Path: "/api/workorder/deleteWorkOrderInstance", Method: "DELETE", Title: "删除工单实例", Type: "1", Pid: 48},
		{Path: "/api/workorder/approvalWorkOrderInstance", Method: "POST", Title: "审批工单", Type: "1", Pid: 48},
		{Path: "/api/workorder/actionWorkOrderInstance", Method: "POST", Title: "执行工单动作", Type: "1", Pid: 48},
		{Path: "/api/workorder/commentWorkOrderInstance", Method: "POST", Title: "评论工单", Type: "1", Pid: 48},
		...
		{Path: "/api/jobexec/getJobExecScriptOne", Method: "GET", Title: "获取单个脚本", Type: "1", Pid: 70},
		{Path: "/api/jobexec/getJobExecScriptDetail", Method: "GET", Title: "获取脚本详情", Type: "1", Pid: 70},
		...
		{Path: "/api/jobexec/deleteJobExecScript", Method: "DELETE", Title: "删除脚本", Type: "1", Pid: 70},
		// 任务管理
		{Path: "/api/jobexec/getJobExecTaskList", Method: "GET", Title: "获取任务列表", Type: "1", Pid: 70},
		{Path: "/api/jobexec/getJobExecTaskOne", Method: "GET", Title: "获取单个任务", Type: "1", Pid: 70},
		...
		{Path: "/api/jobexec/deleteJobExecTask", Method: "DELETE", Title: "删除任务", Type: "1", Pid: 70},
		{Path: "/api/jobexec/actionJobExecTaskOne", Method: "POST", Title: "执行任务", Type: "1", Pid: 70},
		...
		// Prometheus 集群
		{Path: "/api/monitor/getMonitorPromScrapePoolList", Method: "GET", Title: "获取Prom集群列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/createMonitorPromScrapePool", Method: "POST", Title: "创建Prom集群", Type: "1", Pid: 85},
		{Path: "/api/monitor/updateMonitorPromScrapePool", Method: "POST", Title: "更新Prom集群", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromScrapePool", Method: "DELETE", Title: "删除Prom集群", Type: "1", Pid: 85},
		...
		// Prometheus 采集任务
		{Path: "/api/monitor/getMonitorPromScrapeJobList", Method: "GET", Title: "获取采集任务列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/getMonitorPromScrapeJobOne", Method: "GET", Title: "获取单个采集任务", Type: "1", Pid: 85},
		{Path: "/api/monitor/createMonitorPromScrapeJob", Method: "POST", Title: "创建采集任务", Type: "1", Pid: 85},
		{Path: "/api/monitor/updateMonitorPromScrapeJob", Method: "POST", Title: "更新采集任务", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromScrapeJob", Method: "DELETE", Title: "删除采集任务", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorPromScrapeJobStatus", Method: "POST", Title: "设置采集任务状态", Type: "1", Pid: 85},
		// 告警规则
		{Path: "List/api/monitor/getMonitorPromAlertRuleList", Method: "GET", Title: "获取告警规则列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/createMonitorPromAlertRule", Method: "POST", Title: "创建告警规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/updateMonitorPromAlertRule", Method: "POST", Title: "更新告警规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromAlertRule", Method: "DELETE", Title: "删除告警规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromAlertRuleBatch", Method: "DELETE", Title: "批量删除告警规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorPromAlertRuleStatus", Method: "POST", Title: "设置告警规则状态", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorPromAlertRuleStatusBatch", Method: "POST", Title: "批量设置告警规则状态", Type: "1", Pid: 85},
		{Path: "/api/monitor/promqlExprCheck", Method: "GET", Title: "检查PromQL表达式", Type: "1", Pid: 85},
		// 预聚合规则
		{Path: "/api/monitor/getMonitorPromRecordRuleList", Method: "GET", Title: "获取聚合规则列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/createMonitorPromRecordRule", Method: "POST", Title: "创建聚合规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/updateMonitorPromRecordRule", Method: "POST", Title: "更新聚合规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromRecordRule", Method: "DELETE", Title: "删除聚合规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/deleteMonitorPromRecordRuleBatch", Method: "DELETE", Title: "批量删除聚合规则", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorPromRecordRuleStatus", Method: "POST", Title: "设置聚合规则状态", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorPromRecordRuleStatusBatch", Method: "POST", Title: "批量设置聚合规则状态", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/deleteMonitorAlertManagerPool", Method: "DELETE", Title: "删除Alert集群", Type: "1", Pid: 85},
		// AlertManager 发送组
		...
		{Path: "/api/monitor/deleteMonitorAlertManagerSendGroup", Method: "DELETE", Title: "删除发送组", Type: "1", Pid: 85},
		{Path: "/api/monitor/setAlertManagerSendGroupStatus", Method: "POST", Title: "设置发送组状态", Type: "1", Pid: 85},

		// 告警事件
		{Path: "/api/monitor/getMonitorAlertManagerEventList", Method: "GET", Title: "获取告警事件列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertManagerEventSilence", Method: "POST", Title: "静默告警事件", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertManagerEventUnSilence", Method: "POST", Title: "解除静默", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertManagerEventBatchSilence", Method: "POST", Title: "批量静默告警", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertManagerEventBatchUnSilence", Method: "POST", Title: "批量解除静默", Type: "1", Pid: 85},
		{Path: "/api/monitor/alertManagerEventReLing", Method: "POST", Title: "认领告警事件", Type: "1", Pid: 85},

		// 值班组
		{Path: "/api/monitor/getMonitorOndutyGroupList", Method: "GET", Title: "获取值班组列表", Type: "1", Pid: 85},
		{Path: "/api/monitor/getMonitorOndutyGroupOne", Method: "GET", Title: "获取单个值班组", Type: "1", Pid: 85},
		{Path: "/api/monitor/getMonitorOndutyGroupFuturePlan", Method: "GET", Title: "获取排班计划", Type: "1", Pid: 85},
		...
		{Path: "/api/monitor/deleteMonitorOndutyGroup", Method: "DELETE", Title: "删除值班组", Type: "1", Pid: 85},
		{Path: "/api/monitor/createMonitorOndutyChange", Method: "POST", Title: "创建交接班记录", Type: "1", Pid: 85},
		{Path: "/api/monitor/setMonitorOndutyStatus", Method: "POST", Title: "设置值班状态", Type: "1", Pid: 85},
