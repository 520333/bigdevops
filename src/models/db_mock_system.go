...
func mockSystemData(sc *config.ServerConfig) *User {
	menus := []*Menu{
		...
		{Name: "ServiceTree", Title: "服务树与CMDB", Icon: "ant-design:database-outlined", Type: "0", Show: "1", OrderNo: 10, Component: "LAYOUT", Path: "/serviceTree", Redirect: "/serviceTree/service/index"},
