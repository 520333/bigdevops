	...
	modules := []MenuModule{
		...
		// 容器集群
		{
			...
			Children: []*Menu{
				...
				{Name: "K8sYamlTemplateManagement", Title: "YAML 模板", Icon: "ant-design:file-text-outlined", Type: "1", Show: "1", OrderNo: 54, Component: "k8s/yamlTemplate/index", Path: "yamlTemplate"},
				{Name: "K8sYamlTaskManagement", Title: "YAML 发布任务", Icon: "ant-design:play-square-outlined", Type: "1", Show: "1", OrderNo: 55, Component: "k8s/yamlTask/index", Path: "yamlTask"},
			},
		},
		...
		// cicd
		{
			...
			Children: []*Menu{
				{Name: "CiCdWorkList", Title: "工单列表", Icon: "ant-design:database-outlined", Type: "1", Show: "1", OrderNo: 61, Component: "cicd/workorder/index", Path: "workorder"},
				{Name: "CiCdDeployList", Title: "发布工单", Icon: "ant-design:rocket-outlined", Type: "1", Show: "1", OrderNo: 62, Component: "cicd/deploy/index", Path: "deploy"},
				...
				{Name: "CiCdPipeline", Title: "流水线管理", Icon: "ant-design:branches-outlined", Type: "1", Show: "1", OrderNo: 64, Component: "cicd/pipeline/index", Path: "pipeline"},
		...
		// 代码管理
		{
			...
			Children: []*Menu{
				{Name: "CodeRepoManagement", Title: "仓库管理", Icon: "ant-design:database-outlined", Type: "1", Show: "1", OrderNo: 71, Component: "code/repo/index", Path: "repo"},
				...
				{Name: "CodeServerManagement", Title: "实例管理", Icon: "ant-design:api-outlined", Type: "1", Show: "1", OrderNo: 73, Component: "code/server/index", Path: "server"},
		...
		// 效能度量
		{
			...
			Children: []*Menu{
				{Name: "EffDashboard", Title: "效能看板", Icon: "ant-design:code-outlined", Type: "1", Show: "1", OrderNo: 81, Component: "dora/dashboard/index", Path: "dashboard"},
		...
		// 系统管理
		{
			...
			Children: []*Menu{
				...
				{Name: "ApiManagement", Title: "接口授权", Icon: "ant-design:api-outlined", Type: "1", Show: "1", OrderNo: 95, Component: "system/api/index", Path: "api"},
				{Name: "SystemSetting", Title: "系统设置", Icon: "ant-design:setting-twotone", Type: "1", Show: "1", OrderNo: 96, Component: "system/settings/index", Path: "settings"},
			},
		},
	}
